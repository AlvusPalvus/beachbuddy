...
const Form = () => {
    ...
    const [selectedOption, setSelectedOption] = useState<string>(
        useAppSelector((state) => state.userOptions.travelMode)
    );
    ...
    return (
        <form className="flew w-1/2 p-10" onSubmit={handleSubmit}>
            ...
            <div className="flex p-3 gap-x-4 pb-7">
                ...
                <div className=" w-24">
                    <button
                        className="py-2 w-full h-12 text-sm bg-lgblue text-dkblue text-base font-semibold rounded-full shadow-md hover:bg-teal hover:text-white transition-color duration-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
                        type="submit"
                    >
                        Hämta
                    </button>
            ...
            <label className="text-white">Hur vill du resa?</label>
            <div className="flex p-3 gap-x-6 pb-8">
                <div className="h-12 w-1/4">
                    ...
                    <div className="flex items-center">
                        <input
                            checked={selectedOption === "BICYCLING"}
                            onChange={handleInputChange}
                            id="cykel"
                            type="radio"
                ...
                <div className="h-12 w-full">
                    <div className="flex items-center mb-4">
                        <input
                            checked={selectedOption === "TRANSIT"}
                            onChange={handleInputChange}
                            id="kollektivt"
                            type="radio"
                    ...
                    <div className="flex items-center">
                        <input
                            checked={selectedOption === "DRIVING"}
                            onChange={handleInputChange}
                            id="bil"
                            type="radio"
            ...
            <div className="flex p-3 gap-x-6 justify-center">
                <Link
                    to={"/badplatser"}
                    className="text-center text-sm pt-3 pb-2 w-full h-12 bg-lgblue text-dkblue font-semibold rounded-full shadow-md hover:bg-teal transition-color duration-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
                >
                    Hitta badplatser!
                </Link>
            </div>
