...
export const WeatherIcon = (props: Props) => {
    ...
    return(
        <div>
            ...
            {weatherCategory === 2 && <BsFillCloudSunFill size={55} color="#E5F3F1" />}
            {weatherCategory === 3 && <BsFillCloudsFill size={55} color="#E5F3F1" />}
            {weatherCategory === 4 && <BsFillCloudDrizzleFill size={55} color="#E5F3F1" />}
            {weatherCategory === 5 && <BsFillCloudSnowFill size={55} color="#E5F3F1" />}
            {weatherCategory === 6 && <BsFillCloudLightningRainFill size={55} color="#E5F3F1" />}
            {weatherCategory === 7 && <BsCloudHazeFill size={55} color="#E5F3F1" />}
        </div>
    );
}